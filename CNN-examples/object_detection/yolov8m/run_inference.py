...
def main(args):
    ...
    if args.evaluate:
        ...
        mAP, mAP50, mAP75 = evaluate_on_coco(
            args.model_input,
            ort_session,
            coco_dataset=args.coco_dataset,
            device=args.device,
            num_max_images=args.eval_max_images,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        metavar='N',
        help='If set with --evaluate, only run the first N COCO val images (faster smoke test; mAP is not comparable to full val).',
    )
